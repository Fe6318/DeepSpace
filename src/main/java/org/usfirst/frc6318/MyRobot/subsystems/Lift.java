...
public class Lift extends Subsystem {
    ...
    private PWMVictorSPX speedControllerLift;
    ...
    public Lift() {
        ...
        speedControllerLift = new PWMVictorSPX(6);
        addChild("Speed Controller Lift",speedControllerLift);
        speedControllerLift.setInverted(false);
    ...
    public PWMVictorSPX getSpeedController() {
        return speedControllerLift;
    }
